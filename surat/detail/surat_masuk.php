        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= $base_url; ?>surat/masuk.php">Surat Masuk</a></li>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger btn-sm" onclick="suratMasuk('<?= encode_id($surat['id']); ?>')">
        ...
        <?php } else { 
            ...
            <div class="border p-3 text-center" id="preview-container">
                <?php if ($isWordFile) { ?>
                    ...
                    <a href="<?= $base_url; ?>download/surat_masuk.php?id_surat=<?= encode_id($surat['id']); ?>" class="btn btn-primary">Download File</a>
                <?php } else { ?>
