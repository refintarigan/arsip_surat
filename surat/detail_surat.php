...
$surat = decode_id('surat_masuk', $_GET['id_surat'], 'id');
if (empty($surat)) {
...
<div class="wrapper">
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="masuk.php">Surat Keluar</a></li>
     ...
     <div class="container mt-4">
        <h2 class="mb-4 text-center">Data Surat Masuk</h2>
                        ...
                        <td>
                            ...
                            <div class="modal fade" id="edit_mail" tabindex="-1" role="dialog" aria-labelledby="edit_mail_label" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <form class="text-left p-3" action="proses_data/proses_data_all.php" method="post" enctype="multipart/form-data">
                                        <div class="modal-content shadow-lg rounded">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" name="waktu_masuk" value="<?= date('Y-m-d', strtotime($surat['waktu_masuk'])); ?>" class="form-control" id="waktu_masuk">
                                                            </div>
                                            ...
                                            <div class="modal-footer d-flex justify-content-between">
                                                ...
                                                <button type="submit" name="btnEditSurat" class="btn btn-success">
                            ...
                            <a href="proses_data/proses_data_all.php?hapus_surat=<?= encode_id($surat['id']); ?>">
        ...
        <?php } else { 
            ...
            $filePath = '../../assets/files/surat_masuk/' . $surat['lampiran'];
...
<?php include "../component/infolder/js.php"; ?>
   <script>
    $(document).ready(function () {
        let fileUrl = "../assets/files/surat_masuk/<?php echo $surat['lampiran']; ?>"; 
