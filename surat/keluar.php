      ...
      <div class="container">
        ...
        <div class="col-sm text-right">
            <button type="button" data-toggle="modal" data-target="#add_mail" class="btn btn-primary">
                <i class="fas fa-fw fa-plus"></i> Tambah Surat Keluar
            </button>
                        ...
                        <div class="modal-content shadow-lg rounded">
                            <div class="modal-header bg-primary text-white">
                                <h5 class="modal-title" id="add_mail_q">
                                    <i class="fas fa-envelope-open-text"></i> Tambah Surat Keluar
                                </h5>
                            ...
                            <div class="modal-footer d-flex justify-content-between">
                                ...
                                <button type="submit" name="btnTambahSuratKeluar" class="btn btn-success">
              ...
              <table class="table table-bordered table-hover table-striped" id="table_id">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $surat['kepada']; ?></td>
                    <td>
                      <a href="<?= $base_url; ?>surat/detail/surat_keluar.php?id_surat=<?= encode_id($surat['id']); ?>" class="btn btn-sm mb-1 btn-info"><i class="fas fa-eye"></i> Detail</a>
                    </td>
                  </tr>
                  <?php }; ?>
                </tbody>
